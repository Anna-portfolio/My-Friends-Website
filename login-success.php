    ...
    <main>
        <section>
            <div class="login-container">
                ...
                <div>
                    <img src="images/icons/success-tick.png" height="250px" width="250px"><br><br>
                    <h2>Start <a href="browse-friends.php">browsing your friends</a> now</h2>
                    <h2>or <a href="faq.html">find answers to your questions at FAQ</a></h2><br><br><br>
                    <h3>You'll be redirected to "Browse Friends" in <span class="redirect-counter"></h3><br>
                </div>
            </div>
        </section>
